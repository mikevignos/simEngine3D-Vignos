...
a2.body1 = 1;
a2.body2 = 4;
a2.pointOnBody1 = [2 0 0]';
a2.pointOnBody2 = [0.1 0 0]';
a2.vector1OnBody1 = [0 1 0]';
a2.vector2OnBody1 = [0 0 1]';
a2.vector1OnBody2 = [1 0 0]';
a2.vector2OnBody2 = [0 0 1]';
a2.constraintName = 'Translation joint b/w slider and ground';
