...
if 0
    ...
    analysisTime = toc;
    save('simplePendulumWithRevoluteJoint.mat','sys');
else
    load('simplePendulumWithRevoluteJoint.mat')
end

disp(['Dynamics Analysis for simplePendulumWithRevoluteJoint took ' num2str(analysisTime) ' seconds.'])
